function findIpiTrains(folder)
%collect all data in folder 
...
for y = 1:file_num
    ...
    if TG == 1
        ...
        culled_ipi = ipiStats.culled_ipi;
        ...
        varstruc.ipiTrains.d= ipis;
        varstruc.ipiTrains.t= times;
        
        varstruc.ipiTrains.variables.date = date;
        varstruc.ipiTrains.variables.time = clock;
