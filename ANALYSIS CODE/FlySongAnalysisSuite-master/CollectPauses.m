...
for y = 1:file_num
    ...
    if TG == 1
        i = i+1;
            ...
            file_names{i} = file;
            BoutPauses{i} = pauses.BoutPauses;
...
BoutPauses(cellfun('isempty',BoutPauses)) = [];
...
BoutPausesMat = cat(1,BoutPauses{:});
...
PausesMat.BoutPauses = BoutPausesMat;
