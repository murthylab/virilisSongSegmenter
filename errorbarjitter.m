...
if strcmp(barends,'no') == 1
    scatter(x+offset,mean_d,[],'sk','filled')
else
    errorbar(mean_d,e,'sk','MarkerFaceColor','k','XData',x+offset)
end
%plot error lines
for i = 1:n_categories
    line([x(i)+offset x(i)+offset],[mean_d(i)-e(i) mean_d(i)+e(i)],'Color','k','LineWidth',2)
end
